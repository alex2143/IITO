...
function getFileFromServer(doneCallback) {
    var xhr;
	var url = "assets/plattegrond-data/plattegrond3.csv";
...
<div class="col-md-12">
	<div class="plattegrond_container">
		<img src="assets/images/plattegrond3.png" class="plattegrond" />
	</div>
...
$coordinates = fopen("assets/plattegrond-data/plattegrond3.csv", "r") or die("Unable to open file!");
